// Yılbaşı mesajları veritabanı
export const messages = [
  "Bugün advent calendarımızın ilk günü ilk güne de seni çok sevdiğimi söyleyerek başlamak istedim ❤️", // 1 Aralık
  "Bugün benim doğum günüm eminim ki çok güzel sürprizler hazırladın ama en güzeli sensin 🍰", // 2 Aralık
  "İyi ki varsın  ❤️", // 3 Aralık
  "Kendine güzel bir takipçi manifesti yap inan bana gerçek olucak 777 🎁", // 4 Aralık
  "Bugün çok güzel görünüyorsun", // 5 Aralık
  "Geçen sene bugün napıyordun ? ✅", // 6 Aralık
  "Eski yılbaşı fotoğraflarına bak, anıları tazele 📷", // 7 Aralık
  "Eroscuğa bir öpücük ver 💋", // 8 Aralık
